...
<table style="width: 100%; margin: 5px;">
    ...
    while ($count < $sumcount) {
        ...
        echo '">
                ...
                <td style="text-align: center">' . $getlist[$count][6] . '</td>
             ...
             <button onClick="deleteitemn(this.id)" class="btn btn-danger   "  id="' . $getlist[$count][2] . '">Xóa</button>
           <a href="?select=edituser&id=' . $getlist[$count][1] . '">
                <button  id="' . $getlist[$count][1] . '" class="btn btn-primary">Chỉnh sửa</button>
            </a>
